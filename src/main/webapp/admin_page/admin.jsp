...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Điều Khiển</h1>
					<div class="row">
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-area me-1"></i>Doanh Thu Theo Ngày
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i> Doanh Thu 6 Tháng Đầu Năm
								</div>
								<div class="card-body">
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script src="${pageContext.request.contextPath }/admin_page/js/scripts.js"></script>
	<script
